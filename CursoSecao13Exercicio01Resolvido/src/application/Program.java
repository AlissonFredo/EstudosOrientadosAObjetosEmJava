...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		int numberContracts = keyboard.nextInt();
		
		for(int i = 1; i <= numberContracts; i++) {
			
			System.out.println("Enter contract #" + i + " data:");
			System.out.print("Date (DD/MM/YYYY): ");
			Date contractDate = simpleDateFormat.parse(keyboard.next());
		...
		/*estou recortando a String e criando uma subString e convertendo ela para inteiro*/
		int month = Integer.parseInt(monthAndYear.substring(0, 2));
		int year = Integer.parseInt(monthAndYear.substring(3));
		
		System.out.println("Name: " + worker.getName());
		/*estou indo dentro de worker entrando em department e acessando o name de department*/
